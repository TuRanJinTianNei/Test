...
### test8.m - 功率谱密度（PSD）计算仿真

**功能**：功率谱密度计算、采样过程仿真与混叠现象演示
...
- 测试信号频率：`f1 = 440 Hz`（A4音符）、`f2 = 880 Hz`（A5音符）、`f3 = 1320 Hz`、`f4 = 5000 Hz`
...
**应用场景**：学习功率谱密度计算、理解采样定理、分析混叠现象、信号处理基础教学
...
- `README_test8.md` - test8详细说明（功率谱密度计算与采样定理）
...
- 需要完整BER-SNR曲线：使用test1/test3/test4/test5/test6
